...
- 2026-08-24 | e2e-playwright-docker | Compose de e2e vive em docker-compose.e2e.yml na raiz do projeto-alvo; specs Playwright em e2e/. [invalidado-em: 2026-09-01] [substituido-por: skills/e2e/SKILL.md]
- 2026-08-24 | e2e-playwright-docker | Escolha de ferramenta e2e não-web é registrada na Constituição do projeto-alvo (pergunta única por projeto). [invalidado-em: 2026-09-01] [substituido-por: skills/e2e/SKILL.md]
- 2026-08-25 | grafo-v2 | Hooks e wrappers .cmd ficam em LF (.gitattributes): cmd.exe aceita LF, bash quebra com CRLF em Linux/macOS. [invalidado-em: 2026-09-01] [substituido-por: .gitattributes]
...
- 2026-08-25 | grafo-v2 | Corte de tokens do v2 (65-70%) é estimativa do estudo — benchmark pulado por decisão humana; medir se a travessia voltar a doer. [invalidado-em: 2026-09-01] [substituido-por: docs/audora/arquivo/2026-08-31-memory-fatiada.md]
- 2026-08-25 | comandos-ingles | Identificadores do framework (nomes de skills, categorias de risco, enum de estado) são em inglês; prosa segue em português. [invalidado-em: 2026-09-01] [substituido-por: MEMORY.md]
...
- 2026-08-25 | comandos-ingles | `description` de skill sempre entre aspas simples no YAML — `: ` sem aspas quebra o loader (skill carrega com metadata vazia). [invalidado-em: 2026-09-01] [substituido-por: tests/test-skills.sh]
- 2026-08-25 | comandos-ingles | Mensagens de hook citam caminho ABSOLUTO do plugin (resolvido de `$0`), nunca relativo ao projeto-alvo. [invalidado-em: 2026-09-01] [substituido-por: tests/test-memory-validate.sh]
- 2026-08-25 | comandos-ingles | Estado PT→EN converte TODOS na primeira escrita; schema v1→v2 é on-touch — sempre nomear o substantivo (estado vs schema) ao falar de migração. [invalidado-em: 2026-09-01] [substituido-por: docs/audora/arquivo/2026-08-25-comandos-ingles.md]
