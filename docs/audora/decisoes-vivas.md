...
- 2026-08-15 | skill-depurar | depurar é skill-ferramenta (como grafo), não fase do roteamento; dois modos: sintoma e caçada. [invalidado-em: 2026-09-01] [substituido-por: tests/test-skills.sh]
...
- 2026-08-25 | comandos-ingles | Identificadores do framework (nomes de skills, categorias de risco, enum de estado) são em inglês; prosa segue em português. [invalidado-em: 2026-09-01] [substituido-por: tests/test-skills.sh]
...
- 2026-08-25 | comandos-ingles | Estado PT→EN converte TODOS na primeira escrita; schema v1→v2 é on-touch — sempre nomear o substantivo (estado vs schema) ao falar de migração. [invalidado-em: 2026-09-01] [substituido-por: tests/test-skills.sh]
