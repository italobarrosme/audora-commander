...
- memory-fatiada | in-progress | Memory fatiada | Skill memory vira roteador fino + references carregáveis por operação — corta 45% do custo de carga da skill mais chamada do framework | memory, tokens, references, overhead, performance | skills/memory/
